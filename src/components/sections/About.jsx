...
const NeuralOrb = ({ opacity }) => {
  ...
  const handleMouseMove = function(e) {
    ...
    var rect = orbWrapRef.current.getBoundingClientRect();
  ...
  var wrapTransform = 'perspective(600px) rotateX(' + tiltX + 'deg) rotateY(' + tiltY + 'deg) scale(' + (isHovering ? '1.05' : '1') + ')';
  var wrapTransition = 'transform ' + (isHovering ? '0.12s' : '0.5s') + ' ease';
