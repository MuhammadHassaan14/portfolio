...
const NeuralOrb = ({ opacity }) => (
  <div style={{
    ...
    <style>{`
      ...
      .orb-label:nth-of-type(1) { top: -24px; left: 50%; transform: translateX(-50%); animation-delay: 0s; }
      .orb-label:nth-of-type(2) { bottom: -24px; left: 50%; transform: translateX(-50%); animation-delay: 1s; }
      .orb-label:nth-of-type(3) { right: -60px; top: 50%; transform: translateY(-50%); animation-delay: 2s; animation-name: label-float-side; }
